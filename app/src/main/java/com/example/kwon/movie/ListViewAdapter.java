...
public class ListViewAdapter extends BaseAdapter {
    ...
    public void addItem(Drawable icon, String title, String genre, String openDt, String saleshare){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView genreTextView = (TextView) convertView.findViewById(R.id.textview2) ;
        ...
        genreTextView.setText(listViewItem.getDesc());
